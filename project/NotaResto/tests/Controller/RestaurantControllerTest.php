...
class RestaurantControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'restaurant[postcode]' => 'Testing',
            'restaurant[address]' => 'Testing',
            'restaurant[phone]' => 'Testing',
            'restaurant[images]' => 'Testing',
            'restaurant[opinion]' => 'Testing',
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'restaurant[postcode]' => 'Something New',
            'restaurant[address]' => 'Something New',
            'restaurant[phone]' => 'Something New',
            'restaurant[images]' => 'Something New',
            'restaurant[opinion]' => 'Something New',
        ...
        self::assertSame('Something New', $fixture[0]->getOpinion());
